...
public class ProfileActivity extends AppCompatActivity implements Asnychronus_notifier
{
    ...
    String            pref_firstname, pref_lastname, pref_mobile, pref_photopath, changed_photopath, customerid, res_CustomerId, res_CompanyID, res_UserId, res_PhotoPath, res_FirstName, res_LastName, res_MobileNo, res_carInfo, res_abtMe, pref_carinfo, pref_aboutme;
    ...
    private void set_sharedpref_data()
    {
        ...
        pref_firstname = preferences.getString("first_name", "");
        ...
        Log.e("Name", "" + pref_firstname + ".." + pref_firstname.length());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        if (resultCode == RESULT_OK)
        {
            ...
            if (requestCode == 10)
            {
                ...
                Picasso.with(ProfileActivity.this).load(selectedPath).skipMemoryCache().error(R.mipmap.ic_default_pic_rounded).transform(new CircleTransform()).into(profile_img);
                Log.e("IMage  6", "666");
...
/*
    ...
    public void callservice_editProfile()
    {
        ...
        {
            final Json_AsnycTask tsk = new Json_AsnycTask(ProfileActivity.this, GlobalConstants.Url + "Customer/UpdateProfile", GlobalConstants.POST_SERVICE_METHOD1, data_edit_profile);
            tsk.setOnResultsListener(this);
            tsk.execute();
            dialog = ProgressDialog.show(ProfileActivity.this, "", "Updating. Please wait...", true);
